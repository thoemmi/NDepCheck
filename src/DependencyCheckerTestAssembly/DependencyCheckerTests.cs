...
using DependencyCheckerTest.dirUEmlAEutSZ;
using DependencyCheckerTest.dirümläutö;

namespace DependencyCheckerTest.dir1.dir3 {
    /// <summary>
    ...
    public class Class13A {
        ...
        public Class13A(string t) {
            T[0][0] = t;
            S = "DependencyCheckerTests.dir1.dir3.Class13d";
        }
    }
...
public class NamespacelessTestClassForDependencyChecker {
    public static int I;

    static NamespacelessTestClassForDependencyChecker() {
        I = new Random().Next();
    }
}

namespace DependencyCheckerTest.dir1 {
...
namespace DependencyCheckerTest.dir1.dir2 {
    ...
    public class SomeClass {
        ...
        protected static void OtherMethod(Class13D[] d) {
            var auxVar = new Class13A("DependencyCheckerTest.dir1.dir3.SomeClass");
        ...
        protected internal static int AnotherMethod(Class13D d) {
            new Class13A("DependencyCheckerTest.dir1.dir3.SomeClass");
            return NamespacelessTestClassForDependencyChecker.I;
        }
...
namespace DependencyCheckerTest.dir1.dir4 {
...
namespace DependencyCheckerTest.dirümläut {
    public class Class14 {
        public int Method() {
...
namespace DependencyCheckerTest.dirümläutö {
    public class ClassA {
...
namespace DependencyCheckerTest.dirUEmlAEut {
...
namespace DependencyCheckerTest.dirUEmlAEutSZ {
...
namespace DependencyCheckerTest.dirumlaut {
    public class Class14 {
        public int Method() {
...
namespace DependencyCheckerTest.dirumlauts {
    public class ClassA {
        public static int Mäthod() {
            return 0;
        }
